...
The Solana network for your current interactions.
...
A 32-byte public key from a Ed25519 keypair, generally displayed as a base-58 encoded string
(e.g., `7MNj7pL1y7XpPnN7ZeuaE4ctwg3WeufbX5o85sA91J1`).
The corresponding private key signs transactions from this address.
An address can serve as:
- The unique identifier for a user's wallet
