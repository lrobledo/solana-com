...
See the relevant code regarding [account size](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/program/src/system_instruction.rs#L85)
and [account structure](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/account/src/lib.rs#L48-L60).
...
Compute units are used to measure the computational resources used to process a transaction.
...
See also [rent exempt](#rent-exempt) below. 
{//The "What is rent?" link was antiquated, it just goes to the Transaction Fees page, which doesn't mention rent//}

See the relevant code for [calculating rent](https://github.com/anza-xyz/agave/blob/v2.1.13/sdk/rent/src/lib.rs#L93-L97)
using these
...
SWQoS allows
[preferential treatment for transactions that come from staked validators](/developers/guides/advanced/stake-weighted-qos).
